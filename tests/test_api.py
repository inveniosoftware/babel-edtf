...
from babel_edtf import edtf_to_datetime, format_edtf, parse_edtf, parse_edtf_level0

separator = "\u2009–\u2009"


@pytest.mark.parametrize(
    "edtfstr,locale,format,expected",
    [
        # ## Dates
        # Year (en)
        ("2020", "en", "short", "2020"),
        ...
        ("2020-09/2021-11", "en", "long", f"September 2020{separator}November 2021"),
        ("2020-09/2021-11", "en", "full", f"September 2020{separator}November 2021"),
...
def test_format_edtf_format():
    ...
    assert (
        format_edtf("2020/2021", format="yM", locale="en")
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("1985-04-12T23:20:30", DateAndTime(Date("1985", "04", "12"), "23:20:30")),
        # Complete representations for calendar date and UTC time of day
        ("1985-04-12T23:20:30Z", DateAndTime(Date("1985", "04", "12"), "23:20:30Z")),
